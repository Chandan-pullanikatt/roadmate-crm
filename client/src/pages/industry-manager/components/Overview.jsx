      ...
      {execModal && (() => {
        ...
        const EXEC_MODAL_CONFIG = {
          calls: {
            ...
            color: 'var(--blue)',
            emptyMsg: 'No call records found for this district manager.',
          ...
          converted: {
            ...
            color: 'var(--teal)',
            emptyMsg: 'No converted leads found for this district manager.',
          ...
          hot: {
            ...
            color: 'var(--red)',
            emptyMsg: 'No active hot leads for this district manager.',
