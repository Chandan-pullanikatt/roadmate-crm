    ...
    <div className="animate-in fade-in duration-500 space-y-6">
          ...
          <div className="flex items-center gap-3">
             <div className="relative">
                <input 
                  ...
                  className="bg-surface2/50 border border-border rounded-xl pl-10 pr-4 py-2 text-sm w-72 focus:bg-white transition-all"
                />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-border overflow-hidden">
          ...
          <div className="flex gap-3">
             <div className="relative">
                <input 
                  ...
                  className="bg-surface2/30 border border-border rounded-lg pl-9 pr-4 py-1.5 text-xs w-64 focus:bg-white"
                  value={searchTerm}
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-border font-medium text-text-primary">
              ...
              {leads.length === 0 && !isLoading && (
                 <tr><td colSpan="8" className="p-16 text-center text-text-muted italic">No leads matching your criteria.</td></tr>
              )}
              {isLoading && (
        ...
        <div className="flex justify-between items-center p-5 border-t border-border bg-surface2/10">
          <div className="text-xs text-text-muted font-medium">Showing {leads.length} leads in the current view</div>
          <div className="flex gap-2">
